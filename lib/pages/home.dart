            ...
            child:Material(
              ...
              child: Container(
                ...
                child:Column(
                  ...
                  Text("Count: "+ds["Age"], style:TextStyle(color: Colors.orange,fontSize:20.0, fontWeight:FontWeight.bold),),
                  Text("Des: "+ds["Location"], style:TextStyle(color: Colors.blue,fontSize:20.0, fontWeight:FontWeight.bold),)
                ],
                )
    ...
    return  Scaffold(
      ...
      appBar: AppBar(title: Row(
        ...
        fontWeight: FontWeight.bold),),
          Text("FireBase CRUD ",style: TextStyle(color:const Color.fromARGB(255, 65, 243, 33),
        fontSize:24.0, 
        fontWeight: FontWeight.bold),),
    ...
    content: Container(
      child: Column(
        ...
        Row(children:[
          ...
          ), SizedBox(width: 60.0,),  Text("Edit",style: TextStyle(color:Colors.blue,
        fontSize:20.0, 
        fontWeight: FontWeight.bold),),
          Text("Details",style: TextStyle(color:const Color.fromARGB(255, 65, 243, 33),
        fontSize:20.0, 
        fontWeight: FontWeight.bold),)
        ],),
        SizedBox(height: 20.0,),
          ...
          Container( 
            ...
            SizedBox(height: 20.0,),
            Text("Count:", style: TextStyle(color: Colors.black,fontSize: 20.0,fontWeight:FontWeight.bold),),
          SizedBox(height: 10.0,),
          Container( 
            padding: EdgeInsets.only(left:10.0),
            decoration: BoxDecoration(
            ...
            child: TextField(
              ...
              SizedBox(height: 20.0,),
            Text("Des:", style: TextStyle(color: Colors.black,fontSize: 20.0,fontWeight:FontWeight.bold),),
          SizedBox(height: 10.0,),
          Container( 
            padding: EdgeInsets.only(left:10.0),
            decoration: BoxDecoration(
